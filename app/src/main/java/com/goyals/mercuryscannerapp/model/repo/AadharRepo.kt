...
class AadharRepo @Inject constructor(private val aadharApi: AadharApi) :
  ...
  suspend fun getUsers(listRequest: ListRequest) = getResult {
    aadharApi.getCustomers(listRequest)
  }

  suspend fun updateCustomer(updateCustomerSchema: UpdateCustomerSchema,
    userId: Int) = getResult {
    aadharApi.updateCustomer(updateCustomerSchema, userId)
  }
}